...
class TestPageModels(TestCase):
    ...
    def setUpTestData(cls):
        ...
        cls.articlepage1 = ArticlePageFactory(parent=cls.articleindexpage,
                                              themes=(cls.theme1, cls.theme2,), featured=True)
    ...
    def test_article_page_is_served(self):
        ...
        # page serve method will return TemplateResponse object
        # (but with only HttpResponse attributes, due to limitations of RequestFactory)
